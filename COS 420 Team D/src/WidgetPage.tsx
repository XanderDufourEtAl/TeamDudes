...
function WidgetPage() {
    ...
    const [widgets, setWidgets] = useState<{ id: number; type: "Baseball" | "Hockey" | "Football" | "CountDown1"; position: { x: number; y: number } }[]>([]);
    ...
    const addWidget = (type: "Baseball" | "Hockey" | "Football" | "CountDown1") => {
        const newWidget = {
            id: widgets.length + 1,
            type,
